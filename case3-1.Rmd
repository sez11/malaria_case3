...
```
The histogram of village greenery illustrates that the majority of observations (72.8%) were in villages with a greenery value of 40.85. There is a relatively even representation amongst the other unique values of greenery, with greenery values of 28.85, 33.65, 40.10 and 47.65 recieving 3.4%, 10.4%, 8.6%, and 4.2% of observations, respectively. 
...
The bednet use variable has 317 missing cases, which will have to be handled in our analysis. Of the complete bednet cases in the data set, 70.5% use a Bednet for complete while 29.5% do not. Bivariate analyses will provide more information about the relationships between these four variables and malaria presence. 
